...
class InteractiveImageLabel(QLabel):
    def __init__(self, parent=None):
        ...
        # Measurement tool state (used for pixel-size calibration from a scale bar)
...
class MicrogliaAnalysisGUI(QMainWindow):
    ...
    def _create_left_panel(self):
        ...
        self.redo_outline_btn.setStyleSheet("background-color: #FFB300; color: black;")
        ...
        self.undo_point_btn.setStyleSheet("background-color: #FFB300; color: black;")
        ...
        self.clear_masks_btn.setStyleSheet("background-color: #E53935; color: black;")
    ...
    # ========================================================================
    # PIXEL CALIBRATION FROM SCALE BAR
    # ========================================================================
    ...
    def _calibrate_from_measurement(self):
        ...
        if not label or label.measure_pt1 is None or label.measure_pt2 is None:
            QMessageBox.information(
                self, "Calibrate",
                "Draw a measurement line first: click 'Calibrate', then click two points on the scale bar."
            )
            return
